...
Правое колесо:
1) Координаты: (100; 0,866)
$0,866 = 100k + b$
3) Координаты: (150; 0,1086)
$0?1086 = 150k +b$

Была получена формула прямой: $y = 0,00044x + 0,0426$, где $k=0,00044$ и $b=0,0426$.
...
Была получена формула прямой: $y = 0,0003x + 0,0470$, где $k=0,0003$ и $b=0,0470$.
